...
export function getDays():Day[] {
  return [
    {id:1,date:'09.27',weekday:'星期日',short:'长春 → 齐齐哈尔',title:'长春 → 齐齐哈尔',subtitle:'车送到美仑，交接后直接出发，第一晚落脚万达嘉华。',road:'美仑酒店 → 万达嘉华 · 长途转场',budget:'暂留 7–8 小时，酒店交车手续另计',note:'9/26 住美仑；9/27 车辆送到酒店。出发前检查车况、油电、轮胎与随车物品，确认租车授权驾驶人并熟悉车辆。交车时间尚未提供，按实际到车时间调整出发；第一天不加扎龙半日游，抵达齐齐哈尔后晚餐留给烤肉。',stops:['美仑酒店交车 · 检查车况后出发','入住嘉华 · 晚饭与休息'],legs:['meilun_wanda']},
