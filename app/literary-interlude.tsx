...
export function LiteraryInterlude({ motionEnabled, onRouteSelect }: Props) {
  ...
  return <section ref={section} id="right-bank" className="literary-interlude culture-story" aria-labelledby="literary-heading" data-motion={motionEnabled}>
    ...
    <article id="culture-river" className="culture-river culture-scene" data-foliage="birch" data-culture-scene aria-labelledby="river-work-title">
    ...
    <aside className="culture-photography culture-scene" data-foliage="larch" data-culture-scene aria-labelledby="photography-title">
    ...
    <article id="culture-grassland" className="culture-grassland culture-scene" data-foliage="grass" data-culture-scene aria-labelledby="grassland-work-title">
    ...
    <article id="culture-cinema" className="culture-cinema culture-scene" data-foliage="grass" data-culture-scene aria-labelledby="cinema-work-title">
    ...
    <article id="culture-homecoming" className="culture-homecoming culture-scene" data-foliage="poplar" data-culture-scene aria-labelledby="homecoming-work-title">
