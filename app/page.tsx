...
export default function Home() {
  ...
  return <main className="atlas">
    ...
    <nav className="mobile-day-switcher" aria-label="切换行程日期" style={leafVariables(dayId) as CSSProperties}>
      ...
      <div className="mobile-day-current" aria-live="polite"><span className="mobile-day-meta"><span className="mobile-day-leaf" aria-hidden="true"><img src="/autumn-birch.png" alt=""/></span><span>DAY {String(day.id).padStart(2,'0')} · {day.date}</span></span><strong>{day.short}</strong></div>
